...
This reporting scheme remains widely used because qualitative and binary marker are practical, communicable, and testable. They compress large genomics datasets into concise cell type--gene pairs, enabling resources such as CellMarker, which contains 26{,}915 curated marker pairs from published studies \citep{Hu2022CellMarker}, and PanglaoDB which contains 8,286 markers compiled by over 29 tissues \citep{Franzn_2019}. Their simplicity also enables automated extraction and curation. MarkerGeneBERT processed 3{,}702 studies to compile 7{,}901 cell type--marker pairs in only a few hours \citep{Cheng_2024}.

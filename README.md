...
- analysis
  ...
  - comparison: Marker gene comparisons
    - [intra_cmp.ipynb](analysis/comparison/intra_cmp.ipynb)
  - llm
    - [llm_extract.ipynb](analysis/llm/llm_extract.ipynb)
    - [ollama_playground.ipynb](analysis/llm/ollama_playground.ipynb)
    - [workflow_demo.ipynb](analysis/llm/workflow_demo.ipynb)
  - verify
    - [verify_derived.ipynb](analysis/verify/verify_derived.ipynb): Verify that the derived attributes are correct
    - [verify_extraction.ipynb](analysis/verify/verify_extraction.ipynb): Verify that human data was correctly extracted
    - [verify_llm_extraction.ipynb](analysis/verify/verify_llm_extraction.ipynb): Verify that llm data was correctly extracted
    - [verify_source_extraction.ipynb](analysis/verify/verify_source_extraction.ipynb): Verify that source_rationale exists in text.

- data: list of all datasets
- docs: llmarker website db

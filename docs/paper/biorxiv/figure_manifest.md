...
| Figure 2 | `fig:marker_selection`, `fig:llm_curation` | `tex-figures/fig2_marker_recovery.tex`, `tex-figures/fig2_marker_recovery_body.tex` | `analysis/figures/fig2_panel_a_modality_deg_presence.pdf`, `fig2_panel_b_rank_recovery.pdf`, `fig2_panel_c_llm_recovery.pdf` | `analysis/build_fig2_marker_recovery.py` |
| Figure 3 | `fig:corpus_marker_reuse` | `tex-figures/fig3_mrkr_corpus_reuse.tex` | `analysis/figures/fig3_corpus_reuse_v2.pdf` | `analysis/build_fig3_corpus_reuse.py` (figure), `analysis/analyze_mrkr_corpus.py` (artifacts) |
| Figure 4 | `fig:cap_partition` | `tex-figures/fig4_cap_partition.tex`, `tex-figures/fig4_cap_partition_body.tex` | `analysis/figures/fig4_cap_partition_v2.pdf` | `analysis/build_fig4_cap_partition.py` (figure), `analysis/build_cap_liver_local_global_deg.py`, `analysis/build_cap_liver_barcode_constant_deg.py` (artifacts) |
...
- `analysis/artifacts/fig2_modality.tsv`
- `analysis/artifacts/fig2_deg_presence.tsv`
- `analysis/artifacts/fig2_optimal_deg_cutoff.tsv`
- `analysis/artifacts/fig2_rank_recovery.tsv`
- `analysis/artifacts/fig2_rank_recovery_summary.tsv`

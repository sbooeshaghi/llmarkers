...
`docs/paper/biorxiv/main.tex` imports thin LaTeX wrappers from `docs/paper/biorxiv/tex-figures/`.

| Role | Paper reference | LaTeX wrapper/body | Figure artifacts | Source |
| --- | --- | --- | --- | --- |
| Figure 1 | `fig:paper_celltype_joint` | `docs/paper/biorxiv/tex-figures/fig_paper_celltype_joint.tex`, `docs/paper/biorxiv/tex-figures/fig_paper_celltype_joint_body.tex` | TikZ in body file | `docs/paper/biorxiv/tex-figures/fig_paper_celltype_joint_body.tex` |
| Figure 2 | `fig:marker_selection`, `fig:llm_curation` | `docs/paper/biorxiv/tex-figures/fig2_marker_recovery.tex`, `docs/paper/biorxiv/tex-figures/fig2_marker_recovery_body.tex` | `analysis/figures/fig2_panel_a_benchmark_summary.pdf`, `analysis/figures/fig2_panel_b_optimal_deg_cutoff.pdf`, `analysis/figures/fig2_panel_c_llm_recovery.pdf` | `analysis/build_fig2_marker_recovery.py` |
| Figure 3 A-F | `fig:cross_study_unification` | `docs/paper/biorxiv/tex-figures/fig3_cross_study_unification.tex`, `docs/paper/biorxiv/tex-figures/fig3_cross_study_unification_body.tex` | `analysis/figures/fig3_panel_a_joint_distribution.pdf` through `analysis/figures/fig3_panel_f_cap_local_global_recovery.pdf` | `analysis/build_fig3_local_global_marker_identifiability.py` |
...
| Supplementary Hildreth figure | `fig:hildreth_detail` | `docs/paper/biorxiv/tex-figures/figs1_hildreth_detail.tex` | `analysis/figures/fig_hildreth_detail.pdf` | `analysis/lfc_comparison.ipynb` |
| Supplementary benchmark table | `tab:benchmark` | inline in `docs/paper/biorxiv/main.tex` | table source in manuscript tree | benchmark curation notebooks |
| Supplementary LLM curation table | `tab:llm_curation` | inline in `docs/paper/biorxiv/main.tex` | table source in manuscript tree | `analysis/build_fig2_marker_recovery.py` |
...
Outputs are written to `docs/paper/biorxiv/tex-figures/standalone/build/`, which is ignored
